% --> Para ejecutar correctamente este codigo debería comentar una de las
...
maxiter = 100;
% --> Acá creamos el eje real(x), imaginario(y) y la cantidad máxima de
% iteraciones.
...
% números complejos que se encuentren en estos intervalos. Ejecutamos la
% función conver que nos dice si el número evaluado converge o no la
% función del conjunto de Mandelbrot. Si converge lo pinta de negro(0),
...
% si el numero converge o no lo convierto en 0 (falso). Tomé 10 porque creí que
% tenía que comparar los números complejos pero como no son comparables la
% norma me ayuda a saber que tan cerca del origen está entonces el 10 lo
% que me dice es si esta muy lejos o no (en mi caso propio) de (0,0).

% --> 2do caso : llegó a las maximas iteraciones y la norma es mayor o
% igual que 10, entonces bool = 0 porque no converge.

% --> 3er caso : Llegó a las maximas iteraciones pero la norma del numero
